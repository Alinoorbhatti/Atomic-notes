...
# Write all research files first
for data in concepts_data:
    r_file = os.path.join(research_dir, f"{data['slug']}.md")
    
    # Construct research file content
    content = []
    content.append(f"CONCEPT: {data['title']}")
    content.append(f"SLUG: {data['slug']}")
    content.append(f"DEFINITION: {data['definition']}")
    content.append("")
    content.append("KEY_POINTS:")
...
print(f"Successfully generated {len(concepts_data)} research files.")
