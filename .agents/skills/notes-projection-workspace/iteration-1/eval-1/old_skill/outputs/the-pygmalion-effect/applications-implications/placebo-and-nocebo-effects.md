...
tags: [the-pygmalion-effect, applications-implications, placebo-and-nocebo-effects]
aliases: [Placebo Effect, Nocebo Effect]
status: seedling
created: 2026-07-12
sources: ["https://en.wikipedia.org/wiki/Placebo", "https://thedecisionlab.com/biases/placebo-effect", "https://vertexaisearch.cloud.google.com/grounding-api-redirect"]
connections: ["neurobiological-mediators-of-expectation", "the-concept-of-self-fulfilling-prophecy", "the-galatea-effect", "the-golem-effect", "experimenter-expectancy-effect", "pygmalion-in-healthcare"]
---
...
```mermaid
graph TD
    A[Medical Suggestion & Conditioning] -->|Patient Expects Relief| B[Placebo Response: Opioid/Dopamine Release]
    A -->|Patient Expects Side Effects| C[Nocebo Response: CCK & Cortisol Elevation]
    B -->|Causes| D[Physical Healing & Pain Relief]
    C -->|Causes| E[Physical Distress & Adverse Symptoms]
    
    style B fill:#d4f7d4,stroke:#333,stroke-width:2px
    style C fill:#f7d4d4,stroke:#333,stroke-width:2px
```
...
- [[pygmalion-in-healthcare|Pygmalion in Healthcare]] — The broader application of provider expectancy effects in medical treatment.
